...
class _CreditCardWidgetState extends State<CreditCardWidget>
        ...
        children: <Widget>[
          AnimationCard(
            ...
            child: buildFrontContainer(
                width, height, context, orientation, sizingInformation),
          ),
          AnimationCard(
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: CustomText(
                          text: cartaoController.cartao.cvv.isEmpty
                              ? isAmex ? 'XXX' : 'XXX'
                              : cartaoController.cartao.cvv,
                          fontSize: lowMobile ? 12 : mediumMobile ? 14 : 16,
                          color: Colors.black,
                        ),
                      ),
                    ),
          ...
          Expanded(
            ...
            child: Align(
              ...
              child: Padding(
                ...
                child: getCardTypeIcon(cartaoController.cartao.numeroCartao,
                    lowMobile, mediumMobile),
              ),
            ),
          ),
        ],
  ...
  Container buildFrontContainer(
    ...
    return Container(
      ...
      width: widget.width ?? width,
      height: widget.height ?? lowMobile ? 120 : 190,
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Align(
          ...
          Expanded(
            child: Padding(
              ...
              child: CustomText(
                text: cartaoController.cartao.numeroCartao.isEmpty ||
                        cartaoController.cartao.numeroCartao == null
                    ? 'XXXX XXXX XXXX XXXX'
                    : cartaoController.cartao.numeroCartao,
                fontSize: lowMobile ? 12 : mediumMobile ? 14 : 16,
          ...
          Expanded(
            ...
            child: Padding(
              padding: const EdgeInsets.only(left: 16),
              child: CustomText(
                text: cartaoController.cartao.dataExpiracao.isEmpty ||
                        cartaoController.cartao.dataExpiracao == null
                    ? 'MM/AAAA'
                    : cartaoController.cartao.dataExpiracao,
                fontSize: lowMobile ? 12 : mediumMobile ? 14 : 16,
                fontWeight: FontWeight.bold,
                color: Colors.white,
              ),
          ...
          Expanded(
            child: Padding(
              ...
              child: CustomText(
                text: cartaoController.cartao.nomeTitular.isEmpty ||
                        cartaoController.cartao.nomeTitular == null
                    ? 'TITULAR'
                    : cartaoController.cartao.nomeTitular,
                fontSize: lowMobile ? 12 : mediumMobile ? 14 : 16,
                fontWeight: FontWeight.bold,
                color: Colors.white,
              ),
  ...
  Widget getCardTypeIcon(String cardNumber, bool lowMobile, bool mediumMobile) {
    Widget icon;
    switch (detectCCType(cardNumber)) {
      case CardType.visa:
        icon = Image.asset(
          'assets/images/visa.png',
          height: lowMobile ? 30 : mediumMobile ? 40 : 48,
          width: lowMobile ? 30 : mediumMobile ? 40 : 48,
        );
        isAmex = false;
        break;
